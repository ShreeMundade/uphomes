                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '8i4lqg52' /* Let us know what you thought o... */,
                          ),
                          textAlign: TextAlign.start,
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'o1b5forr' /* How would you rate it? */,
                            ),
                            textAlign: TextAlign.start,
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: FFLocalizations.of(context).getText(
                        '6ump1g8r' /* Please leave a description of ... */,
                      ),
