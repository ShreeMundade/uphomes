                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowChoiceChips(
                              options: [
                                ...
                                ChipData(FFLocalizations.of(context).getText(
                                  'okyc0i03' /* No Breakfast */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  'dnqr0w45' /* Hot Tub Access */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  'rqp76o12' /* No Access */,
                                ))
