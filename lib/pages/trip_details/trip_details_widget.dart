                  ...
                  if (widget.tripRef?.complete ?? true)
                    Column(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'zd0y2tz1' /* Your trip has been completed! */,
                          ),
                          style: FlutterFlowTheme.of(context).titleMedium,
                        ),
